...
\- `advanced\_search\_enabled`: Master flag for entire feature

\- `advanced\_search\_filters`: Individual filter types can be enabled/disabled

\- `advanced\_search\_saved\_prefs`: Saved preferences feature
